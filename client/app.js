...
async function sendMessage(text, isRetry = false){
    ...
    if (conv && conv.messages) {
        // نأخذ آخر 4 رسائل (استثني الرسالة الحالية التي يتم إرسالها الآن)
        // ملاحظة: الرسالة الجديدة "Sending..." لم تضاف بعد لقائمة الرسائل الثابتة في السيرفر
...
// --- Version Display Logic ---
    const APP_VERSION = 'v1.275.5'; // يمكنك تحديث هذا يدوياً عند كل تحديث للكاش
