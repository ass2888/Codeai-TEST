    ...
    function typeLoop() {
        if (typeQueue.length > 0) {
            ...
            if (currentAiMsgElement) {
                ...
                // أثناء الكتابة: نص خام فقط (بدون marked)
                
        currentAiMsgElement.textContent = fullMarkdownBuffer;
...
function finishMessageProcessing() {
  ...
  ? marked.parse(fullMarkdownBuffer)
  : fullMarkdownBuffer;
...
// --- Version Display Logic ---
    const APP_VERSION = 'v1.273.9'; // يمكنك تحديث هذا يدوياً عند كل تحديث للكاش
