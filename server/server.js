...
`;
  ...
  const reasoningConfig = MODEL_CONFIGS[taskInfo.reasoning_model];
const keyInfo = getSafeKeyForModel(taskInfo.reasoning_model);
...
if (requestedModel === "auto" || requestedModel === "codeai-pro") {
    ...
    finalModel = routeResult.reasoning_model; // مثل qwen-coder
